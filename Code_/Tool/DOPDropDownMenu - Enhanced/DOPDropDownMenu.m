...
#define kTableViewCellHeight 43*ScreenWidth/375
#define kTableViewHeight 300*ScreenWidth/375
#define kButtomImageViewHeight 21*ScreenWidth/375
...
- (CAShapeLayer *)createSeparatorLineWithColor:(UIColor *)color andPosition:(CGPoint)point {
    ...
    layer.path = path.CGPath;
    layer.lineWidth = 1*ScreenWidth/375;
...
- (void)animateIndicator:(CAShapeLayer *)indicator Forward:(BOOL)forward complete:(void(^)())complete {
    [CATransaction begin];
    [CATransaction setAnimationDuration:0.25*ScreenWidth/375];
