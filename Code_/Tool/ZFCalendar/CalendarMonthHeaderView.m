...
#define CATDayLabelWidth  40.0f*ScreenWidth/320
#define CATDayLabelHeight 20.0f*ScreenWidth/320
...
- (void)setup
{
    ...
    //月份
    UILabel *masterLabel = [[UILabel alloc] initWithFrame:CGRectMake(10.f*ScreenWidth/320, 10.0f*ScreenWidth/320, 300.0f*ScreenWidth/320, 30.f*ScreenWidth/320)];
    [masterLabel setBackgroundColor:[UIColor clearColor]];
    [masterLabel setTextAlignment:NSTextAlignmentCenter];
    [masterLabel setFont:[UIFont fontWithName:@"HelveticaNeue" size:17.0f*ScreenWidth/320]];
    self.masterLabel = masterLabel;
    self.masterLabel.textColor = COLOR_THEME;
    [self addSubview:self.masterLabel];
    
    CGFloat xOffset = 5.0f*ScreenWidth/320;
    CGFloat yOffset = 45.0f*ScreenWidth/320;
    ...
    [dayOfTheWeekLabel setFont:[UIFont fontWithName:@"HelveticaNeue-Light" size:15.0f*ScreenWidth/320]];
    ...
    xOffset += CATDayLabelWidth + 5.0f*ScreenWidth/320;
