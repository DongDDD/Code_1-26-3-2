...
- (instancetype)init
{
    self = [super init];
    if (self) {
        self.headerReferenceSize = CGSizeMake(320.0f*ScreenWidth/320, 65.0f*ScreenWidth/320);//头部视图的框架大小
        
        self.itemSize = CGSizeMake((320*ScreenWidth/320)/7, 70.0f*ScreenWidth/320);//每个cell的大小
