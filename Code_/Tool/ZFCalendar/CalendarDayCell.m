...
- (void)initView{
    ...
    //选中时显示的图片
    imgview = [[UIImageView alloc]initWithFrame:CGRectMake(5*ScreenWidth/320, 15*ScreenWidth/320, self.bounds.size.width-10*ScreenWidth/320, self.bounds.size.width-10*ScreenWidth/320)];
    imgview.image = [UIImage imageNamed:@"chack.png"];
    [self addSubview:imgview];
    
    //日期
    day_lab = [[UILabel alloc]initWithFrame:CGRectMake(0, 15*ScreenWidth/320, self.bounds.size.width, self.bounds.size.width-10*ScreenWidth/320)];
    day_lab.textAlignment = NSTextAlignmentCenter;
    day_lab.font = [UIFont systemFontOfSize:14*ScreenWidth/320];
    [self addSubview:day_lab];

    //农历
    day_title = [[UILabel alloc]initWithFrame:CGRectMake(0, self.bounds.size.height-15*ScreenWidth/320, self.bounds.size.width, 13*ScreenWidth/320)];
    day_title.textColor = [UIColor lightGrayColor];
    day_title.font = [UIFont boldSystemFontOfSize:10*ScreenWidth/320];
